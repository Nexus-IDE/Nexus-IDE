...
public class JavaLanguage extends EmptyLanguage {
	...
	public JavaLanguage(NexusEditor editor/*,ArrayList<String> playerItems*/,String file) {
		mEditor = editor;
	...
	public void requireAutoComplete(
        ...
        String currentLine = content.getLine(lineIndex).toString();
        cursorIndex = position.getIndex();
        inputText = content.toString();
        
		codeCompletionHelper.requireAutoComplete(content,currentLine,position,prefix,publisher, extraArguments);
	}
