...
import com.silva.nexuside.resources.databinding.ActivityMainBinding;
import com.silva.nexuside.resources.databinding.LayoutInstallResourcesBinding;
...
public class MainActivity extends AppCompatActivity{
    ...
    public void openFragment(Fragment fragment, String tag) {
        getSupportFragmentManager().beginTransaction()
            ...
            .addToBackStack(null) // its broken 
            .commit();
    }
